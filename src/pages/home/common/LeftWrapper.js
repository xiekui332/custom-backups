...
class LeftCon extends Component {
            ...
            <LeftWrapper>
                ...
                <LeftItemUl
                    ref={(ul) => {this.ul = ul}}>
                    {
                        ...
                        <LeftItemLi
                            ...
                            >
                            {
                                ...
                                :
                                <NavLink to={"/home"} replace activeClassName="handleActice" onClick={() => this.backCus()} >
                                    <img src={customer} alt="" />
                                    <span>客户管理</span>
                                </NavLink>
                            }
                    ...
                    {/* 新增公共客户 */}
                    {
                        user.userType === 2?
                        <LeftItemLi>
                            <NavLink to={"/public"} replace activeClassName="handleActice">
                                <img src={customer} alt="" />
                                <span>公共客户</span>
                            </NavLink>
                        </LeftItemLi>
    ...
    backCus() {
        this.props.handleChangeStick(false)
    };

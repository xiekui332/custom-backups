                        ...
                        <div className={spin || !customerDetail?"isHide":"isShow" }>
                            <RightContentWrapper>
                                <tbody>
                                    ...
                                    <tr>
                                        <td>姓名</td>
                                        <td>{(customerDetail && customerDetail.user && customerDetail.user.name) || <span className="no-data">暂无</span>}</td>
                                    </tr>
                                    <tr>
                                        <td>电话</td>
                                        <td>{(customerDetail && customerDetail.user && customerDetail.user.mobilePhone) || <span className="no-data">暂无</span>}</td>
                                    </tr>
                                    <tr>
                                        <td>机构信息</td>
                                        <td>{(customerDetail && customerDetail.user && customerDetail.user.orgName) || <span className="no-data">暂无</span>}</td>
                                    </tr>
